...
# @frappe.whitelist()
# def store_rsp_in_s3(japp_id=None):
...
#     file_content = get_file_from_link(japp_id)
...
#         file_name = f'{japp_id+formatted_datetime}.pdf'
#         # print(file_content)
#         # Upload file to S3
#         job_application = frappe.get_doc("Job Application", japp_id)
...
#                                                       filters={"attached_to_doctype":"Job Application",
#                                                                "attached_to_name":japp_id,
#                                                                "file_url":job_application.resume,
#                                                                },
#                                                       )
#                     if job_application:
...
#                     return {"status":False,"msg":"Verification of the file upload Failed"}  
#             else:
#                 frappe.throw("Failed to upload Resume to Cloud")
...
# def get_file_from_link(japp_id):
#     try:
#         job_application = frappe.get_doc("Job Application", japp_id)
#         attachment = job_application.resume  # Assuming only one attachment is present
        
#         file_doc = frappe.get_doc("File", {"attached_to_name": japp_id, "attached_to_doctype": "Job Application"})
...
#         # Bucket name and file name
#         bucket_name = s3_doc.bucket
#         folder_name = f'360ITHUB/HR/Recruitment/{japp_id}'
#         file_name = f'{japp_id+"_"+formatted_datetime}.pdf'
#         # print(file_content)
#         # Upload file to S3
