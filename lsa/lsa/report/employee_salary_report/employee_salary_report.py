...
def employee_data(filters):
    ...
    if absent_list:
        ...
        ab_emp[ab.employee_name]+=[ab.name]
    ...
    for emp in emp_list:
        ...
        if emp.employee_name in ab_emp :
            ...
            data_row["lwp"] = 0
            data_row["net_payable_salary"] = 0.00
        ...
        if attendance_map[emp.employee_name]!=working_dates:
            data_row["monthly_salary"] = 0.00
            data_row["pt_deduction"] = 0.00
            data_row["other_deductions"] = 0.00
            data_row["lwp"] = 0
        ...
        net_payable_salary = (net_payable_salary / 30) * (30 - lwp-absent_marked_days-not_marked_days) - (pt_deduction + other_deductions)
