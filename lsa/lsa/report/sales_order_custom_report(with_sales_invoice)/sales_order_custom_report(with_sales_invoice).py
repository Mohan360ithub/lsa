...
def execute(filters=None):
    ...
    columns = [
        ...
        {"label": "Whatapp Count", "fieldname": "what_app_count", "fieldtype": "Data", "width": 50},
...
def get_data(filters):
    ...
    for so in so_s:
        ...
        message_count = frappe.db.count('Message Detail', filters={'document_id': so.name})
